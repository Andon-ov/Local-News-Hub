(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? (module.exports = factory(require('http'), require('fs'), require('crypto'))) : typeof define === 'function' && define.amd ? define(['http', 'fs', 'crypto'], factory) : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self), (global.Server = factory(global.http, global.fs, global.crypto)));
    ...
    var errors = {
        ServiceError, NotFoundError, RequestError, ConflictError, AuthorizationError, CredentialError,
    };
            ...
            if (method == 'OPTIONS') {
                ...
                try {
                    ...
                    if (err instanceof ServiceError$1) {
                        ...
                        // If it happens, it must be debugged in a future version of the newsServer
                        console.error(err);
                        status = 500;
    ...
    var services = {
        jsonstore, users, data: data$1, favicon, admin, util: util$1,
    };
    ...
    const {
        ConflictError: ConflictError$1, CredentialError: CredentialError$1, RequestError: RequestError$2,
    } = errors;
    ...
    function initPlugin$1(settings) {
        ...
        return function decorateContext(context, request) {
            ...
            function register(body) {
                if (body.hasOwnProperty(identity) === false || body.hasOwnProperty('password') === false || body[identity].length == 0 || body.password.length == 0) {
                    ...
                    const newUser = Object.assign({}, body, {
                        [identity]: body[identity], hashedPassword: hash(body.password),
                    });
    ...
    const secret = 'This is not a production newsServer';
    ...
    function initPlugin$3(settings) {
        ...
        const rules = Object.assign({
            '*': {
                '.create': ['User'], '.update': ['Owner'], '.delete': ['Owner'],
            },
        }, settings.rules);
    ...
    var seedData = {
        news: {
            "356b09ed-85f3-49a7-8c35-6f63061c523f": {
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Paul Sawers",
                "title": "Citymapper lowers the paywall for premium features but keeps monthly subscription for removing ads",
                "description": "Citymapper is lowering the paywall around its premium features and introducing a new subscription plan purely for removing ads.",
                ...
                "description": "Samsung is said to ban the use of generative AI tools, including ChatGPT, on company-owned devices and internal networks, Bloomberg reports.",
                ...
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Brian Heater",
                "title": "Viam’s robot prototyping software hits general availability",
                "description": "Viam’s platform hits general availability today, providing support from the prototyping stage to fleet management.",
                ...
                "title": "Woven Capital, Nvidia back Foretellix's autonomous vehicle validation tech",
                "description": "Foretellix raised $43 million to fund its scenario generation and big data analytics to validate the safety of autonomous driving systems.",
                ...
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Rebecca Bellan",
                "title": "Kodiak Robotics is adding an electric, autonomous semi truck to its fleet next year",
                "description": "Kodiak Robotics will upfit a Peterbilt Model 579EV with its self-driving technology and sensors for use in short-haul and drayage deployments.",
                ...
                "title": "New Relic launches Grok, it's AI observability assistant",
                "description": "New Relic introduces Grok, its generative AI assistant for observability, simplifying data analysis and task management for engineers.",
                ...
                "title": "Augmental lets you control a computer (and sex toys) with your tongue",
                "description": "The Augmental team regards MouthPad’s development as part of the normal progression of technology.",
                ...
                "title": "Pietra helped creators start DTC businesses; now it has a roadmap for everyone",
                ...
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Tim De Chant",
                "title": "The era of software-defined battery startups is here",
            ...
            },"356b09ed-85f3-49a7-8c35-6f63061c5231": {
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Paul Sawers",
                "title": "Citymapper lowers the paywall for premium features but keeps monthly subscription for removing ads",
                "description": "Citymapper is lowering the paywall around its premium features and introducing a new subscription plan purely for removing ads.",
                ...
                "category":"Jambol",
                "content": "Citymapper is lowering the paywall around its premium features and introducing a new subscription plan purely for removing ads.\r\nThe move comes less than two months after the popular transit and trav… [+1931 chars]"
            }, "35c5369e-78f3-47e2-b174-7c13a8b34c22": {
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Kate Park",
                "title": "Samsung bans use of generative AI tools like ChatGPT after April internal data leak",
                "description": "Samsung is said to ban the use of generative AI tools, including ChatGPT, on company-owned devices and internal networks, Bloomberg reports.",
                ...
                "category":"Jambol",
                "content": "A month after internal, sensitive data from Samsung was accidentally leaked to ChatGPT, Samsung is cracking down on usage of the generative AI service. The electronics giant is planning a temporary b… [+2978 chars]"
            }, "354d7e54-9e94-4db6-81e6-263d6f7d6dc3": {
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Brian Heater",
                "title": "Viam’s robot prototyping software hits general availability",
                "description": "Viam’s platform hits general availability today, providing support from the prototyping stage to fleet management.",
            ...
            }, "356ffce2-6b4e-4a9b-89f6-839ef3b53dc4": {
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Lauren Simonds",
                "title": "Vote for the breakout sessions you want at Disrupt 2023",
                "description": "It’s time for Audience Choice! Here’s the list of breakouts vying for your vote and a spot at TechCrunch Disrupt 2023.",
                ...
                "category":"Sliven",
                "content": "In early 2022, you may remember, we called for experts to submit applications to present breakout sessions and roundtable discussions at TechCrunch Disrupt 2023, taking place on September 1921 in San… [+3858 chars]"
            }, "35b5c5a5-5a5c-4359-87a7-266d28285f75": {
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Rebecca Bellan",
                "title": "Woven Capital, Nvidia back Foretellix's autonomous vehicle validation tech",
                "description": "Foretellix raised $43 million to fund its scenario generation and big data analytics to validate the safety of autonomous driving systems.",
                ...
                "category":"Jambol",
                "content": "Startups working on driverless cars fully may no longer attract the kind of nine-figure acquisition or funding offers that were prevalent just a few years ago. But there are still pockets within the … [+4204 chars]"
            }, "359af7d3-361c-4477-9f2e-b77d64a68e26": {
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Rebecca Bellan",
                "title": "Kodiak Robotics is adding an electric, autonomous semi truck to its fleet next year",
                "description": "Kodiak Robotics will upfit a Peterbilt Model 579EV with its self-driving technology and sensors for use in short-haul and drayage deployments.",
                ...
                "category":"Jambol",
                "content": "Self-driving trucking company Kodiak Robotics plans to introduce an electric autonomous Class 8 truck to its fleet in 2024. The news comes as California, one of the states Kodiak hopes to do business… [+3081 chars]"
            }, "358ea8f5-99bb-46d6-9dbf-9e944cd686b7": {
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Frederic Lardinois",
                "title": "New Relic launches Grok, it's AI observability assistant",
                "description": "New Relic introduces Grok, its generative AI assistant for observability, simplifying data analysis and task management for engineers.",
                ...
                "category":"Jambol",
                "content": "We’re currently deep in the cycle of every enterprise-adjacent company integrating a large language model into its services. Today, New Relic is throwing its hat in the ring with Grok, which it calls… [+2783 chars]"
            }, "35772f7e-8f85-4287-957d-09e0da57a9e8": {
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Haje Jan Kamps",
                "title": "Augmental lets you control a computer (and sex toys) with your tongue",
                "description": "The Augmental team regards MouthPad’s development as part of the normal progression of technology.",
                ...
                "category":"Straldja",
                "content": "Worldwide, about one in six people live with a disability. Whether through injury or illness, disability can manifest itself as an impediment to mobility. There have been fantastic advancements in co… [+4655 chars]"
            }, "35e15b19-7c1d-48d7-a3a3-3a7107af8549": {
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Christine Hall",
                "title": "Pietra helped creators start DTC businesses; now it has a roadmap for everyone",
                "description": "Pietra enters the commerce enablement sector with a revamped monthly subscription membership for access to free software tools.",
                ...
                "category":"Straldja",
                "content": "The direct-to-consumer business world continues to be noisy. Its not enough to just start up a business and advertise on Google and Facebook: Todays e-commerce merchants have to be masters of all cha… [+3570 chars]"
            }, "35d6efc3-e898-4f8a-bd5c-79c0775bfc10": {
                "source": {"id": "techcrunch", "name": "TechCrunch"},
                "author": "Tim De Chant",
                "title": "The era of software-defined battery startups is here",
                "description": "The battery industry is on the cusp of a radical change, and a $10M seed round raised by Chemix shows why.",
    ...
    var rules$1 = {
        users: {
            '.create': false, '.read': ['Owner'], '.update': false, '.delete': false,
        },
    };
    var settings = {
        identity: identity, protectedData: protectedData, seedData: seedData, rules: rules$1,
    };
